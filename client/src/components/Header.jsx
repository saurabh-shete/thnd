    ...
    return (
        <div className=' bg-[#f3f2f2] p-4 flex flex-col items-center justify-center rounded'>
            ...
            <div className='flex flex-col justify-center  items-center mt-2 sm:mt-4'>
                <p className="text-base sm:text-lg font-semibold text-center mb-2 text-gray-600">Intelligent Farming Companion for Bharat</p>
                <div className="flex items-center space-x-4 mt-2">
                    <button className="flex items-center justify-center w-16 sm:w-20 h-8 rounded bg-green-200 text-green-700">
                        English
                    </button>
